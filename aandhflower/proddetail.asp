...
<table width="1060" cellpadding="0" cellspacing="0">
  <tr>
    <td height="805" valign="top" background="img/bg_2.gif"><div align="center">
        <table width="760" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="2"><img src="slideshow/gallery/header002.jpg" width="760" height="275" /></td>
          </tr>
          <tr>
            <td colspan="2">&nbsp;</td>
          </tr>
          <tr>
            <td colspan="2"><table width="678" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="298" class="yellow">&nbsp;</td>
                  <td height="1" rowspan="2" align="right" valign="top" class="yellow"><form method="post" action="search.asp">
                      <table class="search" width="298" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="102" align="right" class="whitetext style2"><span class="style3">Search:</span> &nbsp;</td>
                          <td class="search" width="104"><input type="hidden" name="posted" value="1"/>
                              <input type="hidden" name="sprice" value=""/>
                              <input class="textarea" type="text" name="stext" size="24"/></td>
                          <td width="58">&nbsp;</td>
                          <td width="34">&nbsp;</td>
                        </tr>
                      </table>
                    </form>
                      <img src="../images/clearpixel.gif" width="1" height="1" alt=""/></td>
                </tr>
                <tr>
                  <td width="298"><img src="../images/clearpixel.gif" width="1" height="1" alt=""/></td>
                </tr>
            </table></td>
          </tr>
          <tr>
            <td width="130" valign="top"><!-- #BeginLibraryItem "/Library/right.lbi" --><table width="120" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td class="news" align="center"><div align="left"><a href="home.html"><img src="images/homebutton.jpg" width="159" height="37" border="0" /></a><br />
          <br />
          <img src="images/news.jpg" width="8" height="14" /> Our store<br />
            <img src="images/rightlinedots.gif" width="126" height="3" alt=""/></div></td>
      </tr>
      <tr>
        <td class="smaller"><div align="left">
          <p>&middot; <a href="categories.asp?cat=10">Favors</a><br />
        &middot;<a href="categories.asp?cat=12"> Impainting</a><br />
        &middot; <a href="categories.asp?cat=13">Wedding Flowers</a><br />
        &middot; <a href="categories.asp?cat=14">Accessories<br />
        </a>&middot; <a href="categories.asp?cat=15">Clearance</a><br />
        &middot; <a href="products.asp">All products</a></p>
          </div></td>
      </tr>
      <tr>
        <td class="news" align="center"><div align="left"><br />
          <img src="images/rightlinedots.gif" width="126" height="3" alt=""/><br />
           <img src="images/news.jpg" width="8" height="14" /> Shopping cart<br />
            <img src="images/rightlinedots.gif" width="126" height="3" alt="" /><br />
...
<!-- #EndLibraryItem --></td>
            <td width="630" valign="top"><table width="100%"  cellspacing="0" cellpadding="8">
                <tr>
                  <td><div align="left">
                    <%
...
updatepricescript(true) %>
                    <table border="0" cellspacing="<%=maintablespacing%>" cellpadding="<%=maintablepadding%>" width="<%=maintablewidth%>" bgcolor="<%=maintablebg%>" align="center">
                      <tr>
                        <td width="100%"><form action="cart.asp" method="post" name="tForm<%=Count%>" id="tForm<%=Count%>" onsubmit="return formvalidator<%=Count%>(this)">
                            ...
                            <table width="<%=innertablewidth%>" border="0" cellspacing="<%=innertablespacing%>" cellpadding="<%=innertablepadding%>" bgcolor="<%=innertablebg%>">
                              <tr>
                                <td class="prodnavigation" colspan="3" align="left" valign="top"><strong>
                                  <p class="prodnavigation"><%=tslist%><br />
                                      <img src="images/clearpixel.gif" width="300" height="8" alt="" /></p>
                                </strong></td>
                                <td align="right" valign="top"><% if nobuyorcheckout<>true then %>
                                    <a href="cart.asp"><img src="images/checkout.gif" border="0" alt="<%=xxCOTxt%>" /></a>
	...
	if usedetailbodyformat=1 OR usedetailbodyformat="" then %>
                            <table width="<%=innertablewidth%>" border="0" cellspacing="<%=innertablespacing%>" cellpadding="<%=innertablepadding%>" bgcolor="<%=innertablebg%>">
                              <tr>
                                <td width="100%" colspan="4"><%						if showproductid=true then response.write "<div class=""detailid""><strong>" & xxPrId & ":</strong> " & rs("pID") & "</div>" %>
                                    <strong>
                                    <div class="detailname">
                                      <% response.write rs(getlangid("pName",1))&xxDot
...
&nbsp;
              <% end if %>
                              ...
                              <tr>
                                <td width="100%" colspan="4"><p align="left">
...
&nbsp;
              <% end if %></td>
                                <td width="60%" align="center" colspan="2"><%	if noprice=true then
						response.write "&nbsp;"
					else
...
&nbsp;
              <%
                                ...
                                <td>&nbsp;</td>
                                <td width="70%" valign="top"><%				totprice = rs("pPrice")
				optionshavestock=true
				if IsArray(prodoptions) then
					optionshavestock=true
				...
				if showproductid=true then response.write "<div class=""detailid""><strong>" & xxPrId & ":</strong> " & rs("pID") & "</div>" %>
                                    <strong>
                                    <div class="detailname">
                                      <% response.write rs(getlangid("pName",1))&xxDot
...
%>
                              ...
                              <tr>
                                <td align="right"><%=xxQuant%>:</td>
                                <td align="left"><input type="text" name="quant" maxlength="5" size="4" value="1" /></td>
                              </tr>
                              <%
	end if
	response.write "</table></div>"
...
%>
                            ...
                            <table border='0' cellspacing='1' cellpadding='1' width='100%'>
                              <tr>
                                <td align="right"><%=xxQuant%>:</td>
                                <td><input type="text" name="quant" maxlength="5" size="4" value="1" /></td>
                              </tr>
                            </table>
                            <%
	end if
...
set rs2 = nothing
set cnn = nothing
%><td width="630" valign="top"><table width="100%"  cellspacing="0" cellpadding="8"><tr><td><div align="left"><table border="0" cellspacing="<%=maintablespacing%>" cellpadding="<%=maintablepadding%>" width="<%=maintablewidth%>" bgcolor="<%=maintablebg%>" align="center"><tr><td width="100%"><form action="cart.asp" method="post" name="tForm<%=Count%>" onsubmit="return formvalidator<%=Count%>(this)"><table width="<%=innertablewidth%>" border="0" cellspacing="<%=innertablespacing%>" cellpadding="<%=innertablepadding%>" bgcolor="<%=innertablebg%>"><tr><td width="70%" valign="top"><strong><div class="detailname"><tbody></tbody></div></strong></td>
            </tr></table>
</form>
          </td>
        </tr></table>
          ...
          <tr>
            <td colspan="2"><div align="center">
                <p class="style1">&copy; A&amp;H Flowers 2007</p>
            </div></td>
          </tr>
          <tr>
            <td colspan="2">&nbsp;</td>
