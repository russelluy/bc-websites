...
<%
'*** File Upload to: ../../../applications/CatalogManager/download, Extensions: "", Form: form1, Redirect: "", "file", "", "over"
...
If (CStr(Request.QueryString("GP_upload")) <> "") Then
  ...
  BuildUploadRequest RequestBin, "../../../applications/CatalogManager/download", "file", "", "over"
...
<form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1" enctype="multipart/form-data" onSubmit="checkFileUpload(this,'');return document.MM_returnValue">
  <table width="100%" align="center" class="tableborder">
    ...
    <tr valign="baseline"> 
      ...
      <td height="28"> <input name="DocFile" type="file" id="DocFile"> </td>
    </tr>
    <tr valign="baseline"> 
      <td nowrap align="right">&nbsp;</td>
