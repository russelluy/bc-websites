...
<%
'*** File Upload to: ../../applications/PhotoGalleryManager/images, Extensions: "GIF,JPG,JPEG,BMP,PNG", Form: imageA, Redirect: "", "file", "", "over"
...
<body>
<form ACTION="<%=MM_editAction%>" METHOD="POST" enctype="multipart/form-data" name="imageA" id="imageA" onSubmit="checkFileUpload(this,'GIF,JPG,JPEG,BMP,PNG');return document.MM_returnValue">
