      ...
      <form ACTION="<%=MM_editAction%>" METHOD="POST" enctype="multipart/form-data" name="form1">
        <table width="100%" align="center" class="tableborder">
          <tr align="right" valign="top">
            <td width="21%" class="style2 style1 tableheader"><strong><span class="style2">Category:</span></strong></td>
            <td width="3%" class="style2 style1 tableheader">&nbsp;</td>
...
%>
              ...
              <span class="style5">| <a href="javascript:;" onClick="MM_openBrWindow('add_category.asp','Category','scrollbars=yes,width=400,height=300')">add/edit
      category</a></span> <img src="questionmark.gif" alt="Select a category that best describes the Image i.e. Sporting Image" width="15" height="15"></td>
          </tr>
          <tr align="right" valign="top">
            <td class="style2 style1 tableheader"><span class="style6">Image Name:</span></td>
            <td class="style2 style1 tableheader">&nbsp;</td>
            <td colspan="2" align="left">
          ...
          <tr align="right" valign="top">
            <td class="style2 style1 tableheader"><span class="style6">Image Description:</span></td>
            <td class="style2 style1 tableheader">&nbsp;</td>
            <td colspan="2" align="left">
          ...
          <tr align="right" valign="top">
            <td class="style2 style1 tableheader"><span class="style6">Image Short Description:</span></td>
            <td class="style2 style1 tableheader">&nbsp;</td>
            <td colspan="2" align="left">
          ...
          <tr align="right" valign="top">
            <td class="style2 style1 tableheader"><span class="style6">Date Added:</span></td>
            <td class="style2 style1 tableheader">&nbsp;</td>
          ...
          <tr align="right" valign="top">
            <td class="style2 style1 tableheader"><span class="style6">Image A:</span></td>
            <td class="style2 style1 tableheader">&nbsp;</td>
            <td width="36%" align="left">            <span class="style5">Large Size:<br>
            </span>              <input name="ImageFileA" type="file" id="ImageFileA" value="" size="32">
              <img src="questionmark.gif" alt="Upload Large Size image" width="15" height="15"></td>
            <td width="40%" align="left"><span class="style5">Thumbnail Size: <br></span>              <input name="ImageThumbFileA" type="file" id="ImageThumbFileA" value="" size="32">
              <img src="questionmark.gif" alt="Upload Thumbnail Size image" width="15" height="15"></td>
          </tr>
          <tr align="right" valign="top">
            <td class="style2 style1 tableheader"><span class="style6">Image B:</span></td>
            <td class="style2 style1 tableheader">&nbsp;</td>
            <td align="left"><span class="style5">Large Size:<br> </span>              <input name="ImageFileB" type="file" id="ImageFileB" value="" size="32">
              <img src="questionmark.gif" alt="Upload Large Size image" width="15" height="15"></td>
            <td align="left"><span class="style5">Thumbnail Size: <br></span>              <input name="ImageThumbFileB" type="file" id="ImageThumbFileB" value="" size="32">
              <img src="questionmark.gif" alt="Upload Thumbnail Size image" width="15" height="15"></td>
          </tr>
          <tr align="right" valign="top">
            <td class="style2 style1 tableheader"><span class="style6">Activated:</span></td>
            <td class="style2 style1 tableheader">&nbsp;</td>
            <td colspan="2" align="left">
